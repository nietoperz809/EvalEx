...
{
    // Generated by ANT
    private static final String BUILD_NUMBER = "470";
...
//        System.exit(0);
    ...
    private static void printBigNumber (MyComplex ret)
    {
        ...
        AnsiConsole.out.print(ret.toPlainStringComplex() + ANSI_NORMAL);
        if (_radix != 0)
        {
            AnsiConsole.out.println(" (r:" + _radix + ")");
        }
        else
        {
            AnsiConsole.out.println();
