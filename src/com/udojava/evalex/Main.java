...
{
    // Generated by ANT
    public static final String BUILD_NUMBER = "282";
    ...
    static final Map<String, BigDecimal> _variables = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    ...
    {
        Expression e = new Expression(s, _history);
        e.addVariables(_variables);
        return e;
    }
