...
{
    // Generated by ANT
    private static final String BUILD_NUMBER = "434";
     ...
     */
    private static final BigComplex PI =
            new BigComplex(
     ...
     */
    private static final BigComplex e = new BigComplex(
    ...
    public static void main (String[] args) throws IOException, InterruptedException, URISyntaxException
    {
        ...
        _variables.put("TRUE", BigComplex.ONE);
        _variables.put("FALSE", BigComplex.ZERO);
        _variables.put("BUILD", new BigComplex(Main.BUILD_NUMBER,"0"));

//        _variables.put("jaja",
//                new BigComplex(2.10130339252156783658165295491926372051239013671875,
//                1.1897377641407580473043026358936913311481475830078125));
//        Expression e = getExpression("jaja");
//        BigComplex ret = e.eval();
//        printBigNumber(ret);
//        System.exit(0);
    ...
    private static void iterate (String s)
    {
        ...
        BigComplex v1 = new BigComplex(toks[0], "0");
        BigComplex v2 = new BigComplex(toks[1], "0");
        BigComplex step = BigComplex.ONE;
        String term = toks[2];
        if (toks.length == 4)
        {
            step = new BigComplex(new BigDecimal(toks[2]).abs(), BigDecimal.ZERO);
            term = toks[3];
        }
    ...
    private static void load (String name) throws IOException, ClassNotFoundException
    {
        try (FileInputStream fin = new FileInputStream(name + ".list"))
        {
            try (ObjectInputStream ois = new ObjectInputStream(fin))
            {
                ...
                _variables.setMap((TreeMap<String, BigComplex>) ois.readObject());
    ...
    private static void printVars (Map m)
    {
        ...
        {
            Map.Entry<String, BigComplex> mo =
                    (Map.Entry<String, BigComplex>) obj;
            String name = mo.getKey();
            BigComplex val = mo.getValue();
    ...
    private static void printBigNumber (BigComplex ret)
    {
        ...
        else
        {
            ...
            BigInteger img = ret.imaginary.toBigInteger();
