...
{
    // Generated by ANT
    private static final String BUILD_NUMBER = "221";
    ...
    public static void help()
    {
        ...
        AnsiConsole.out.println("Type .? to see this help text.");
        AnsiConsole.out.println("Use x, b or o prefix to denote hex, bin or octal numbers.");
        AnsiConsole.out.println("Type '.o' to see list of operators, or '.f' for functions.");
        AnsiConsole.out.println("Both .o and .f can be narrowed giving an argument that is the first char of listed functions.");
        AnsiConsole.out.println("Type '.h' to see the history or '.p' to re-evaluate the last term.");
        ...
        AnsiConsole.out.println("You can save and load the history unsing .s and .l followed by file name.");
        AnsiConsole.out.println("To change the output, type '.r n' where n can be from 2 to 36 inclusively");
        AnsiConsole.out.println("If .r (radix) is 0 then output is presented as real number, otherwise integer.");
        AnsiConsole.out.println("... or type any term - or '.x' to exit ...");
    ...
    private static void runParser (String s)
    {
        ...
        if (_radix == 0)
        {
            AnsiConsole.out.println(ANSI_BOLD+ANSI_WHITEONBLUE+ret.toPlainString()+ANSI_NORMAL);
        }
        else
        {
