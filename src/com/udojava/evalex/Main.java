...
{
    // Generated by ANT
    private static final String BUILD_NUMBER = "347";
    ...
    private static TreeMap<String, BigDecimal> _variables = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
...
//        System.exit(0);
    ...
    private static void iterate (String s)
    {
        ...
        BigDecimal v1 = new BigDecimal(toks[0]);
        BigDecimal v2 = new BigDecimal(toks[1]);
        BigDecimal step = BigDecimal.ONE;
        String term = toks[2];
        if (toks.length == 4)
        {
            step = new BigDecimal(toks[2]).abs();
            term = toks[3];
        }
    ...
    private static void help ()
    {
        ...
        AnsiConsole.out.println(".i accepts 3 or 4 arguments separated by comma. First 2 args are upper and lower level of iteration.");
