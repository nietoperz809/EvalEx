...
{
    // Generated by ANT
    private static final String BUILD_NUMBER = "386";
    ...
    public static void main (String[] args) throws IOException, InterruptedException, URISyntaxException
    {
        ...
        _variables.put("BUILD", new BigNumber(Main.BUILD_NUMBER,"0"));

//        Expression e = getExpression("1+i");
...
//        System.exit(0);
    ...
    private static void iterate (String s)
    {
        ...
        BigNumber v1 = new BigNumber(toks[0], "0");
        BigNumber v2 = new BigNumber(toks[1], "0");
        BigNumber step = BigNumber.ONE;
        String term = toks[2];
        if (toks.length == 4)
        {
            step = new BigNumber(toks[2], "0").abs();
            term = toks[3];
        }
